...
##### 5. using the Command-Line Interface (CLI)
  - Download and setup the [TCP CLI](https://github.com/excellaco/xg)
  - Copy the `xg.yaml` file from this repository to where you will run the CLI
  - Fill out the appropriate fields in `xg.yaml` with the desired values
  - run `xg make`
